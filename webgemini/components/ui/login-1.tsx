...
const Page = () => {
  ...
  return (
    <div className="h-screen w-[100%] bg-[var(--color-bg)] flex flex-col md:flex-row items-center justify-center p-4">
    <div className='card w-full max-w-4xl lg:w-[70%] md:w-[75%] flex flex-col md:flex-row justify-between h-auto md:h-[600px] border border-[var(--color-border-custom)] rounded-xl overflow-hidden shadow-2xl'>
      <div
        className='w-full md:w-1/2 px-4 lg:px-16 left h-full relative overflow-hidden bg-[var(--color-surface)]'
        onMouseMove={handleMouseMove}
        ...
        onMouseLeave={handleMouseLeave}>
          ...
          <div className="form-container sign-in-container h-full z-10 flex flex-col justify-center">
            ...
            <div className='grid gap-4 items-center'>
              ...
              <a href="#" className='font-light text-sm md:text-md text-[var(--color-text-primary)] hover:underline'>Forgot your password?</a>
              <div className='flex gap-4 justify-center items-center mt-4'>
                 <button 
                  className="group/button relative inline-flex justify-center items-center overflow-hidden rounded-md bg-[var(--color-border-custom)] px-6 py-2.5 text-sm font-semibold text-white transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] cursor-pointer"
                >
